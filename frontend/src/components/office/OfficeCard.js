...
export default function OfficeCard({
  ...
  return (
    <div
      className="w-full md:w-4/12 mb-10 px-4 flex justify-center text-center cursor-pointer transform hover:scale-110 transition-transform ease-out duration-300"
      onClick={() => {
        handleClick(section);
      }}
    >
