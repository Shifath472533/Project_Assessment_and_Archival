...
import { updateTeacher } from "Services/OfficeService";
...
export default function EditTask(props) {
	...
	const handleUpdateTeacher = async () => {
		setShowModal(false);
		console.log(FormatDate(dob), email, name, githubUsername, designation);
		const { success, msg, data } = await updateTeacher(
			username,
			name,
			designation,
			FormatDate(dob),
